    ...
    pub fn from(first:Point, second:Point) -> Self {
        Self{
            ...
            magnitude:((first.get_x() - second.get_x()) * (first.get_x() - second.get_x())
             ...
             + (first.get_z() - second.get_z())*(first.get_z() - second.get_z())).sqrt(),
        }
    }
...
mod tests {
    ...
    fn create_new() {
        ...
        assert_eq!(v.get_i() == 1f32 && v.get_j() == 1f32 && v.get_k() == 1f32, true)
    }
    #[test]
    fn create_from(){
        ...
        assert_eq!(v.get_i() == 2f32 && v.get_j() == 1f32 && v.get_k() == 0f32, true);
    }
    ...
    fn test_products(){
        ...
        assert_eq!(cross.get_i() == 1f32 && cross.get_j() == -2f32 && cross.get_k() == 1f32, true);

        let scalar:f32 = 2f32;
        let scaled:Vector = v2 * scalar;
        assert_eq!(scaled.get_i() == 4f32 && scaled.get_j() == 6f32 && scaled.get_k() == 8f32, true);
    }
